...
export class BatchTimmingsClient {
    ...
    getBatchTimmings(): Promise<BatchTimmingsDto[]> {
        let url_ = this.baseUrl + "/api/BatchTimmings";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetBatchTimmings(_response);
        });
    }

    protected processGetBatchTimmings(response: Response): Promise<BatchTimmingsDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(BatchTimmingsDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return Promise.resolve<BatchTimmingsDto[]>(null as any);
    }
}
...
export class MachinesClient {
    ...
    getMachines(): Promise<MachinesDto[]> {
    ...
    protected processGetMachines(response: Response): Promise<MachinesDto[]> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(MachinesDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return Promise.resolve<MachinesDto[]>(null as any);
    }

    createMachines(command: CreateMachinesCommand): Promise<number> {
        let url_ = this.baseUrl + "/api/Machines";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateMachines(response: Response): Promise<number> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
    ...
    updateMachines(id: number, command: UpdateMachinesCommand): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUpdateMachines(_response);
        });
    }

    protected processUpdateMachines(response: Response): Promise<void> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
    ...
    deleteMachines(id: number): Promise<void> {
        let url_ = this.baseUrl + "/api/Machines/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDeleteMachines(_response);
        });
    }

    protected processDeleteMachines(response: Response): Promise<void> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
...
export class SecurityClient {
    ...
    updateCurrentUserPassword(command: UpdatePasswordIdentityCommand): Promise<Result> {
        let url_ = this.baseUrl + "/api/Security";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdateCurrentUserPassword(response: Response): Promise<Result> {
        followIfLoginRedirect(response);
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
...
export class BatchTimmingsDto implements IBatchTimmingsDto {
    id?: number;
    timings?: string;

    constructor(data?: IBatchTimmingsDto) {
        if (data) {
    ...
    static fromJS(data: any): BatchTimmingsDto {
        data = typeof data === 'object' ? data : {};
        let result = new BatchTimmingsDto();
        result.init(data);
        return result;
    }
...
export interface IBatchTimmingsDto {
    id?: number;
    timings?: string;
}
...
export class MachinesDto implements IMachinesDto {
    ...
    static fromJS(data: any): MachinesDto {
        data = typeof data === 'object' ? data : {};
        let result = new MachinesDto();
        result.init(data);
        return result;
    }
...
export class CreateMachinesCommand implements ICreateMachinesCommand {
    ...
    constructor(data?: ICreateMachinesCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateMachinesCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateMachinesCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateMachinesCommand {
    machineNumber?: string;
    languageId?: number;
}

export class UpdateMachinesCommand implements IUpdateMachinesCommand {
    id?: number;
    machineNumber?: string;
    languageId?: number;

    constructor(data?: IUpdateMachinesCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateMachinesCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateMachinesCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateMachinesCommand {
    id?: number;
    machineNumber?: string;
    languageId?: number;
}
...
export class UpdatePasswordIdentityCommand implements IUpdatePasswordIdentityCommand {
    oldPassword?: string;
    newPassword?: string;

    constructor(data?: IUpdatePasswordIdentityCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdatePasswordIdentityCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdatePasswordIdentityCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdatePasswordIdentityCommand {
    oldPassword?: string;
    newPassword?: string;
}
